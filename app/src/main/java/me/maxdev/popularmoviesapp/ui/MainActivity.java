...
public class MainActivity extends AppCompatActivity implements OnItemSelectedListener,
    ...
    // TODO: 7/28/16 listen when click a item in a dialog, use broadcast to communicate between 2 layout in MVP pattern.
    private BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
        // TODO: 7/28/16 different from callback, onreceive usually run on UI thread
        @Override
    ...
    // TODO: 7/28/16 add view, init view
    @Override
    ...
    // TODO: 7/28/16 remember to register and unregister when onResume and onPause
    @Override
